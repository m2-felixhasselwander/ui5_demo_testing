...
sap.ui.define([
	...
	opaTest("should show correct item count after search (1)", function (Given, When, Then) {
		...
		//Actions
		When.onTheViewPage.iEnterTextForSearchAndPressEnter("earn");
	...
	opaTest("should show correct item count after search (0)", function (Given, When, Then) {
		...
		//Actions
		When.onTheViewPage.iEnterTextForSearchAndPressEnter("there should not be an item for this search");

		// Assertions
		Then.onTheViewPage.iShouldSeeItemCount(0);
